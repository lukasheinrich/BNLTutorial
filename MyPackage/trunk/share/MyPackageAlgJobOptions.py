...
#algseq += CfgMgr.xAODMaker__xAODTruthCnvAlg("myAlg",AODContainerName="GEN_EVENT") #uncomment if running on EVNT
algseq += CfgMgr.MyPackageAlg()                                 #adds an instance of your alg to it
...
#xaodStream.AddAcceptAlgs( "MyPackageAlg" ) #will only keep events where 'setFilterPassed(false)' has NOT been called in the given algorithm
